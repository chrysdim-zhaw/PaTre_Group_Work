---
title: "Tracking Personal Mobility: A Spatio-Environmental Analysis of Student Travel Behavior and Emissions Using Google Timeline and SimaPro Data"
...
#| fig-cap: CO₂e emissions (bubble size) and distance travelled (log-scale) per transport mode for Dimitri and Ramon
...
```{r}
#| label: tbl-dimi-co2
#| tbl-cap: CO₂ emissions by transport mode for Dimitri over the two-month period.
